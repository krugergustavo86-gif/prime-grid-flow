...
export function createPatrimonySeed(): PatrimonyData {
  return {
    ...
    loans: [
      ...
      { id: generateId(), contract: "Gerador 01 Prime", institution: "Cresol", type: "Fin. Equipamento", nextPayment: "2025-05-25", totalInstallments: 60, paidInstallments: 20, installmentValue: 3190.02 },
      ...
      { id: generateId(), contract: "Pavilhão – Direto", institution: "Direto", type: "Imóvel", nextPayment: "2025-07-20", totalInstallments: 18, paidInstallments: 12, installmentValue: 10000.00 },
