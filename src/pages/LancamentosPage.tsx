...
export default function LancamentosPage() {
  ...
  const handleNew = () => {
    if (isLocked) {
      toast.error("Este mês está fechado e não pode ser editado");
      return;
    }
    setEditTx(null);
    setModalOpen(true);
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 pb-24 md:pb-4 space-y-4">
        ...
        <TransactionTable transactions={monthTxns} locked={isLocked} onEdit={handleEdit} onDelete={handleDelete} />
      </div>
